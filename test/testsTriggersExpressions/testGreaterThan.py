...
from triggerExpressions import Evaluation, GreaterThan
...
class TestLowerOrEqualsThan(TestCase):
    ...
    def test_eval_true_not_same_integer_integer_with_empty_previous_evaluation(self):
        expr1 = ALitteral(2)
        expr2 = ALitteral(1)
        self.eval_greater_than(self.eval1, expr1, expr2)
    ...
    def eval_greater_than(self, previousEvaluation, expr1, expr2):
        token = None
        trig = GreaterThan(expr1, expr2)
    ...
    def test_eval_false_not_same_integer_integer_with_empty_previous_evaluation(self):
        expr1 = ALitteral(1)
        expr2 = ALitteral(2)
        self.eval_not_greater_than(self.eval1, expr1, expr2)
    ...
    def test_eval_ValueError_integer(self):
        ...
        expr2 = ALitteral(1)
        self.eval_not_greater_than(self.eval2, expr1, expr2)
    ...
    def eval_not_greater_than(self, previousEvaluation, expr1, expr2):
        token = None
        trig = GreaterThan(expr1, expr2)
