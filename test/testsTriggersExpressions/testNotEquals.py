...
from triggerExpressions import Evaluation, NotEquals
...
class TestNotEquals(TestCase):
    ...
    def test_eval_true_integer_string_with_empty_previous_evaluation(self):
        expr1 = ALitteral(1)
        expr2 = ALitteral('abc')
        self.eval_not_equals(self.eval1, expr1, expr2)

    def test_eval_true_string_integer_with_empty_previous_evaluation(self):
        expr1 = ALitteral('abc')
        expr2 = ALitteral(2)
        self.eval_not_equals(self.eval1, expr1, expr2)

    def test_eval_true_float_string_with_empty_previous_evaluation(self):
        expr1 = ALitteral(1.0)
        expr2 = ALitteral('abc')
        self.eval_not_equals(self.eval1, expr1, expr2)

    def test_eval_true_string_float_with_empty_previous_evaluation(self):
        expr1 = ALitteral('abc')
        expr2 = ALitteral(2.0)
        self.eval_not_equals(self.eval1, expr1, expr2)
    ...
    def test_eval_ValueError_integer(self):
        ...
        expr2 = ALitteral(1)
        self.eval_equals(self.eval2, expr1, expr2)
