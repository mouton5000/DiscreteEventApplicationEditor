...
from triggerExpressions import BLitteral, Evaluation
from database import Variable
from test.testsTriggersExpressions import simpleTests


class TestBLitteral(TestCase):
    ...
    def eval_true(self, previousEvaluation):
        lit = BLitteral(True)
        simpleTests.test_evaluation(self, lit, previousEvaluation, None, previousEvaluation)
    ...
    def eval_false(self, previousEvaluation):
        lit = BLitteral(False)
        simpleTests.test_evaluation(self, lit, previousEvaluation, None)